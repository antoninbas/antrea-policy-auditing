...
func (cr *CustomRepo) modifyFile(event auditv1.Event) error {
	...
	resource.Metadata.SetUID("")
	resource.Metadata.SetGeneration(0)
	resource.Metadata.SetManagedFields(nil)
	resource.Metadata.SetCreationTimestamp(metav1.Time{})
	resource.Metadata.SetResourceVersion("")
	annotations := resource.Metadata.GetAnnotations()
	delete(annotations, "kubectl.kubernetes.io/last-applied-configuration")
	resource.Metadata.SetAnnotations(annotations)
